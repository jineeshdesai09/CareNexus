...
CROSS JOIN (SELECT "UserID" FROM public."User" WHERE "Email" = 'doctor@hospital.com' LIMIT 1) u
LIMIT 1
...
FROM public."Hospital" h
CROSS JOIN (SELECT "UserID" FROM public."User" WHERE "Email" = 'patient@hospital.com' LIMIT 1) u
LIMIT 1
ON CONFLICT DO NOTHING;
